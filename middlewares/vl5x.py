...
"""
    ...
    @File        : vl5x.py
    @Create_Date : 2019-05-15 12:49
    @Update_Date : 2019-05-15 12:49
    @Author      : liing
...
def makeKey_5(str1):
    s = base64.b64encode((str1[5:30] + str1[1:3] + '1').encode('utf-8')).decode('utf-8') + str1[36: 39]
...
def makeKey_6(str1):
    s = str1[5:30] + str1[36:39]
    a = base64.b64encode(s[4:14].encode('utf-8')).decode('utf-8') + s[2:]  # .encode('utf-8')
    b = s[6:] + a[2:]
    c = str(strToLong(s[5:])) + s[4:]
    aa = '' + s[4:]
    l = sum([(ord(y) << (x % 16)) + x for x, y in enumerate(a)])
...
def makeKey_7(str1):
    s = base64.b64encode((str1[5: 25] + '55' + str1[1:3]).encode('utf-8')).decode('utf-8') + str1[36:39]
...
def makeKey_8(str1):
    s = base64.b64encode((str1[5: 29] + '5-5').encode('utf-8')).decode('utf-8') + str1[1:3] + str1[36:39]
    l = sum([ord(y) << (x % 16) for x, y in enumerate(s[:-1])])
    aa = str(l) + s[4:]
    a = s[5:]
    l = sum([ord(y) << (x % 16) for x, y in enumerate(a)])
...
def makeKey_9(str1):
    ...
    a = s[5:] + s[4:]
    b = s[12:] + s[-6:]
    c = hashlib.sha1(s[4:].encode('utf-8')).hexdigest() + a[6:]
    return md5(c)[4:28]


def makeKey_10(str1):
    s = base64.b64encode((str1[5:29] + '5').encode('utf-8')).decode('utf-8') + str1[1:3] + str1[36:39]    # ).encode('utf-8')
    l = sum([ord(y) << (x % 16) for x, y in enumerate(s[:-1])])
    aa = str(l) + s[4:]
    a = s[5:]
    l = sum([ord(y) << (x % 16) for x, y in enumerate(a)])
    a = str(l) + '' + s[4:]
    b = md5(s[1:]) + hashlib.sha1(a[5:].encode('utf-8')).hexdigest()
    return md5(b)[4:28]
...
def makeKey_11(str1):
    ...
    l = sum([ord(y) << (x % 16) for x, y in enumerate(a)])
    a = str(l) + '' + s[2:]
    b = s[1:] + hashlib.sha1(a[5:].encode('utf-8')).hexdigest()
    return md5(b)[2: 26]
...
def makeKey_12(str1):
    ...
    l = sum([ord(y) << (x % 16) for x, y in enumerate(a)])
    a = str(l) + '' + s[2:]
    b = s[1:] + hashlib.sha1(s[5:].encode('utf-8')).hexdigest()
    return md5(b)[1:25]
...
def makeKey_13(str1):
    ...
    l = sum([ord(y) << (x % 16) for x, y in enumerate(a)])
    a = str(l) + '' + s[2:]
    b = base64.b64encode((s[1:] + hashlib.sha1(s[5:]).encode('utf-8')).hexdigest())
    return md5(b)[1:25]
...
def makeKey_14(str1):
    ...
    l = sum([ord(y) << (x % 16) for x, y in enumerate(a)])
    a = str(l) + '' + s[2:]
    b = base64.b64encode((s[1:] + s[5:] + s[1:4]).encode('utf-8')).decode('utf-8')
    return hashlib.sha1(b.encode('utf-8')).hexdigest()[1:25]
...
def makeKey_15(str1):
    ...
    l = sum([ord(y) << (x % 16) for x, y in enumerate(a)])
    a = str(l) + '' + s[2:]
    b = base64.b64encode((a[1:] + s[5:] + s[2:5]).encode('utf-8')).decode('utf-8')
    return hashlib.sha1(b.encode('utf-8')).hexdigest()[1:25]
...
def makeKey_16(str1):
    ...
    l = sum([(ord(y) << (x % 16)) + x for x, y in enumerate(a)])
    a = str(l) + '' + s[2:]
    b = base64.b64encode(a[1:].encode('utf-8')).decode('utf-8') + str(strToLongEn2(s[5:], 5)) + s[2:5]
    return md5(b)[2: 26]
...
def makeKey_17(str1):
    ...
    l = sum([(ord(y) << (x % 16)) + x for x, y in enumerate(a)])
    a = str(l) + '' + s[2:]
    b = base64.b64encode(a[1:].encode('utf-8')).decode('utf-8') + str(strToLongEn2(s[5:], 6)) + s[7:10]
    return md5(b)[0:24]
    ...
    def fun():
        try:
            ...
            if retry > 4:
                ...
                raise ValueError ("Get vl5x with wrong!—— {}".format(cookie))
    return fun()
...
if __name__ == '__main__':
    ...
    cookie = '5068f95ff6fc4a6015118f0a4908261072d55c51'
